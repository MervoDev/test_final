...
export function ClientIcon(props: PropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 2a5 5 0 100 10 5 5 0 000-10zM7 20c0-1.657 2.686-3 5-3s5 1.343 5 3v1H7v-1z" />
      <path d="M3 21c0-2.21 3.582-4 8-4s8 1.79 8 4v1H3v-1z" opacity=".4" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M19.43 12.98c.04-.31.07-.63.07-.98s-.03-.67-.07-.98l2.11-1.65a.5.5 0 0 0 .12-.64l-2-3.46a.5.5 0 0 0-.6-.22l-2.49 1a7.028 7.028 0 0 0-1.7-.98l-.38-2.65a.5.5 0 0 0-.5-.42h-4a.5.5 0 0 0-.5.42l-.38 2.65c-.62.23-1.2.55-1.7.98l-2.49-1a.5.5 0 0 0-.6.22l-2 3.46a.5.5 0 0 0 .12.64l2.11 1.65c-.04.31-.07.64-.07.98s.03.67.07.98l-2.11 1.65a.5.5 0 0 0-.12.64l2 3.46a.5.5 0 0 0 .6.22l2.49-1c.5.43 1.08.77 1.7.98l.38 2.65c.04.23.24.42.5.42h4c.26 0 .46-.19.5-.42l.38-2.65c.62-.21 1.2-.55 1.7-.98l2.49 1a.5.5 0 0 0 .6-.22l2-3.46a.5.5 0 0 0-.12-.64l-2.11-1.65zM12 17a5 5 0 1 0 0-10 5 5 0 0 0 0 10z"
      />
    </svg>
  );
}
...
export function Produits(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
...
export function Commandes(props: PropsType) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={24}
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7 18a2 2 0 114 0 2 2 0 01-4 0zm9-2a2 2 0 100 4 2 2 0 000-4zM5.5 3a.75.75 0 000 1.5h1.24l.375 1.5h-.615a.75.75 0 000 1.5h1.01l1.273 5.093a2.25 2.25 0 002.186 1.657h6.867a2.25 2.25 0 002.186-1.782l1.125-5.25A.75.75 0 0019.5 6h-12l-.45-1.8A.75.75 0 006.327 3H5.5zm3.154 5.25l1.094 4.377a.75.75 0 00.729.553h6.867a.75.75 0 00.729-.594L19.943 8.25H8.654z"
      />
    </svg>
  );
}