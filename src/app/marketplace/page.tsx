            ...
            <div className="relative max-w-screen-xl mx-auto rounded-3xl overflow-hidden shadow-lg">
                ...
                <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2">
                    {imagesCarousel.map((_, i) => (
                        <span
                            key={i}
                            className={`w-3 h-3 rounded-full ${i === carouselIndex ? "bg-white" : "bg-white/50"
                                }`}
                        />
                    ))}
                </div>
                ...
                {produitsFiltres.map((produit) => (
                    ...
                    >
                        ...
                        <div className="p-4">
                            ...
                            <span
                                className={`inline-block mt-2 px-3 py-1 text-xs rounded-full font-medium ${produit.statut === "Disponible"
